...
(function () {
  ...
  // Honest defaults for when no backend is reachable (e.g. static host with the
  // API not yet deployed). Replaced by real live/fallback status after hydrate.
  const statusChips = [
    { label: "openFDA", state: "Cached", tone: "warning" },
    { label: "Gemini", state: "Fallback", tone: "warning" },
    { label: "Fivetran", state: "Fallback", tone: "warning" },
    { label: "BigQuery", state: "Fallback", tone: "warning" },
    { label: "MCP", state: "Fallback", tone: "warning" },
    { label: "Backend", state: "Offline", tone: "warning" },
